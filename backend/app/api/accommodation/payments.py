...
class AccommodationStepOffer:
    ...
    #: The step's ``template_config.guest_form``, as stored. Read through
    #: ``guest_form.parse_form``, which tolerates a form that no longer parses.
...
def resolve_lines(
    ...
    for position, (index, line) in enumerate(indexed):
        ...
        # What this checkout asks about the people staying, and whether it was
        ...
        form = parse_form(offer.guest_form)
