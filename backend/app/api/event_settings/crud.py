...
class EventSettingsCRUD(BaseCRUD[EventSettings, EventSettingsCreate, EventSettingsUpdate]):
    """CRUD operations for EventSettings."""

    def __init__(self) -> None:
        super().__init__(EventSettings)

    def get_by_popup_id(self, session: Session, popup_id: uuid.UUID) -> EventSettings | None:
