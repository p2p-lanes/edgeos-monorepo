...
def test_biweekly_interval_count_two() -> None:
    ...
    short = datetime(2026, 2, 14, tzinfo=UTC)
...
def test_weekly_interval() -> None:
    ...
    deadline = datetime(2026, 2, 12, tzinfo=UTC)
...
def test_daily_interval() -> None:
    ...
    deadline = datetime(2026, 1, 21, tzinfo=UTC)
...
def test_yearly_interval() -> None:
    ...
    deadline = datetime(2029, 1, 15, tzinfo=UTC)
