 ...
 * sections, buyer form, confirm summary, FAQ items, cart drawer, insurance
 * card, etc.
 *
 ...
 *
 *   --step-card-bg      (theme `card_background_color`, or per-step override
 *                        applied on a parent SnapSection)
...
export const stepCardSurfaceStyle = (): CSSProperties =>
  ({
    ...
    "--card-foreground":
      "var(--step-card-fg, var(--card-foreground))",
    ...
    background:
      "var(--step-card-bg, var(--checkout-card-bg, var(--card)))",
