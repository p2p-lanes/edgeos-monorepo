...
export class CheckoutService {
    ...
    public static previewOpenTicketing(data: CheckoutPreviewOpenTicketingData): CancelablePromise<CheckoutPreviewOpenTicketingResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/checkout/{slug}/preview',
            path: {
                slug: data.slug
            },
            headers: {
    ...
    public static listCheckoutAccommodations(data: CheckoutListCheckoutAccommodationsData): CancelablePromise<CheckoutListCheckoutAccommodationsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/checkout/{slug}/accommodations',
            path: {
                slug: data.slug
            },
            headers: {
    ...
    public static checkAccommodationAvailability(data: CheckoutCheckAccommodationAvailabilityData): CancelablePromise<CheckoutCheckAccommodationAvailabilityResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/checkout/{slug}/accommodations/availability',
            path: {
                slug: data.slug
            },
            headers: {
