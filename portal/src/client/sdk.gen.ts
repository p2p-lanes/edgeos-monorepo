...
export class CheckoutService {
     ...
     * @throws ApiError
     */
    public static startEmailVerification(data: CheckoutStartEmailVerificationData): CancelablePromise<CheckoutStartEmailVerificationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/checkout/{slug}/email-verification/start',
            path: {
                slug: data.slug
            },
            headers: {
     ...
     * @throws ApiError
     */
    public static confirmEmailVerification(data: CheckoutConfirmEmailVerificationData): CancelablePromise<CheckoutConfirmEmailVerificationResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/checkout/{slug}/email-verification/confirm',
            path: {
                slug: data.slug
            },
            headers: {
