...
export class SalesFlowsService {
     ...
     * @param data.flowId
     * @param data.xTenantId
     * @returns FlowProductAssignmentPublic Successful Response
     * @throws ApiError
     */
    public static listFlowProducts(data: SalesFlowsListFlowProductsData): CancelablePromise<SalesFlowsListFlowProductsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/sales-flows/{flow_id}/products',
            path: {
                flow_id: data.flowId
            },
            headers: {
     ...
     * @throws ApiError
     */
    public static setFlowProducts(data: SalesFlowsSetFlowProductsData): CancelablePromise<SalesFlowsSetFlowProductsResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/sales-flows/{flow_id}/products',
            path: {
