...
export class ApplicationsService {
    ...
    /**
     * Detach Companion
     * Detach the current human from being a companion on another applicant's
     * application for the given popup.
     * Idempotent — returns 204 even when the human is not a companion.
