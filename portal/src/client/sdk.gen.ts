...
export class MeAccessService {
     ...
     * @throws ApiError
     */
    public static getMeAccess(): CancelablePromise<MeAccessGetMeAccessResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getMeAccessDocs(data: MeAccessGetMeAccessDocsData = {}): CancelablePromise<MeAccessGetMeAccessDocsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/me/access/docs',
            query: {
                format: data.format
            },
            errors: {
