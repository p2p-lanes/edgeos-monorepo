...
export const AIConversationPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        usage: {
            '$ref': '#/components/schemas/AIConversationUsageSummary'
        }
    },
    type: 'object',
    required: ['id', 'title', 'messages', 'schema_version', 'revision', 'created_at', 'updated_at', 'expires_at'],
    title: 'AIConversationPublic'
} as const;

export const AIConversationUpsertSchema = {
    properties: {
        messages: {
            items: {
                additionalProperties: true,
    ...
    type: 'object',
    required: ['messages'],
    title: 'AIConversationUpsert'
} as const;

export const AIConversationUsageSummarySchema = {
    properties: {
        input_tokens: {
            type: 'integer',
            title: 'Input Tokens',
    ...
    type: 'object',
    title: 'AIConversationUsageSummary'
} as const;

export const AIExecutionClaimRequestSchema = {
    properties: {
        fingerprint: {
            type: 'string',
            pattern: '^[0-9a-f]{64}$',
    ...
    title: 'AIExecutionClaimRequest'
} as const;

export const AIExecutionClaimResponseSchema = {
    properties: {
        state: {
            type: 'string',
            enum: ['acquired', 'pending', 'completed'],
            title: 'State'
        },
        result: {
            title: 'Result'
    ...
    type: 'object',
    required: ['state'],
    title: 'AIExecutionClaimResponse'
} as const;

export const AIExecutionCompleteRequestSchema = {
    properties: {
        fingerprint: {
            type: 'string',
            pattern: '^[0-9a-f]{64}$',
    ...
    type: 'object',
    required: ['fingerprint', 'result'],
    title: 'AIExecutionCompleteRequest'
} as const;

export const AITranslateRequestSchema = {
    properties: {
        entity_type: {
            type: 'string',
            title: 'Entity Type'
    ...
    type: 'object',
    required: ['entity_type', 'entity_id', 'target_language'],
    title: 'AITranslateRequest'
} as const;

export const AbandonedCartPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        payments: {
            items: {
                '$ref': '#/components/schemas/CartPaymentInfo'
            },
            type: 'array',
            title: 'Payments',
            default: []
...
export const CartPaymentInfoSchema = {
    ...
    title: 'CartPaymentInfo',
    description: 'Embedded payment info for abandoned cart listing.'
} as const;

export const CartPopupInfoSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
...
export const CustomExportSpecSchema = {
    properties: {
        dataset: {
            type: 'string',
            maxLength: 80,
...
export const EventAvailabilityCheckSchema = {
    ...
    title: 'EventAvailabilityCheck'
} as const;

export const EventAvailabilityResultSchema = {
    properties: {
        available: {
            type: 'boolean',
            title: 'Available'
...
export const EventInvitationBulkCreateSchema = {
    ...
    type: 'object',
    required: ['emails'],
    title: 'EventInvitationBulkCreate',
    description: 'Paste-a-list bulk invite. Emails must match humans in the tenant.'
} as const;

export const EventInvitationBulkResultSchema = {
    properties: {
        invited: {
            items: {
                '$ref': '#/components/schemas/EventInvitationPublic'
            },
            type: 'array',
            title: 'Invited'
        },
    ...
    type: 'object',
    required: ['invited', 'skipped_existing', 'not_found'],
    title: 'EventInvitationBulkResult'
} as const;

export const EventInvitationPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
...
export const EventSettingsCreateSchema = {
    properties: {
        ...
        humans_can_create_venues: {
            type: 'boolean',
            title: 'Humans Can Create Venues',
            default: false
        },
...
export const EventVenuePublicSchema = {
    properties: {
        ...
        status: {
            '$ref': '#/components/schemas/VenueStatus',
            maxLength: 20,
            default: 'active'
        },
        display_order: {
        ...
        properties: {
            items: {
                '$ref': '#/components/schemas/VenuePropertyRef'
            },
            type: 'array',
            title: 'Properties',
            default: []
        ...
        photos: {
            items: {
                '$ref': '#/components/schemas/VenuePhotoRef'
            },
            type: 'array',
            title: 'Photos',
            default: []
        ...
        weekly_hours: {
            items: {
                '$ref': '#/components/schemas/VenueWeeklyHourRef'
            },
            type: 'array',
            title: 'Weekly Hours',
            default: []
        ...
        exceptions: {
            items: {
                '$ref': '#/components/schemas/VenueExceptionRef'
            },
            type: 'array',
            title: 'Exceptions',
            default: []
...
export const ExportCatalogPublicSchema = {
    properties: {
        datasets: {
            items: {
                '$ref': '#/components/schemas/ExportDatasetPublic'
            },
            type: 'array',
            title: 'Datasets'
        },
    ...
    type: 'object',
    required: ['datasets', 'formats', 'limits'],
    title: 'ExportCatalogPublic'
} as const;

export const ExportColumnSchema = {
    properties: {
        field: {
            type: 'string',
            maxLength: 120,
...
export const ExportDatasetPublicSchema = {
    properties: {
        dataset: {
            type: 'string',
            title: 'Dataset'
        ...
        fields: {
            items: {
                '$ref': '#/components/schemas/ExportFieldPublic'
            },
            type: 'array',
            title: 'Fields'
        }
    ...
    type: 'object',
    required: ['dataset', 'label', 'description', 'scope', 'row_label', 'fields'],
    title: 'ExportDatasetPublic'
} as const;

export const ExportDownloadRequestSchema = {
    properties: {
        spec: {
            '$ref': '#/components/schemas/CustomExportSpec'
        },
        fingerprint: {
            type: 'string',
            maxLength: 64,
    ...
    type: 'object',
    required: ['spec', 'fingerprint'],
    title: 'ExportDownloadRequest'
} as const;

export const ExportFieldPublicSchema = {
    properties: {
        field: {
            type: 'string',
            title: 'Field'
    ...
    type: 'object',
    required: ['field', 'label', 'type', 'sensitivity', 'filter_operators'],
    title: 'ExportFieldPublic'
} as const;

export const ExportFilterSchema = {
    properties: {
        field: {
            type: 'string',
            maxLength: 120,
        ...
        operator: {
            type: 'string',
            enum: ['eq', 'neq', 'contains', 'not_contains', 'in', 'is_empty', 'not_empty', 'gt', 'gte', 'lt', 'lte', 'before', 'after'],
            title: 'Operator'
        },
        value: {
            title: 'Value'
...
export const ExportPreviewSchema = {
    properties: {
        title: {
            type: 'string',
            title: 'Title'
        ...
        columns: {
            items: {
                '$ref': '#/components/schemas/ExportPreviewColumn'
            },
            type: 'array',
            title: 'Columns'
        },
    ...
    type: 'object',
    required: ['title', 'dataset', 'dataset_label', 'scope', 'row_label', 'estimated_rows', 'columns', 'filters', 'warnings', 'format', 'filename', 'spec', 'fingerprint', 'generated_at'],
    title: 'ExportPreview'
} as const;

export const ExportPreviewColumnSchema = {
    properties: {
        field: {
            type: 'string',
            title: 'Field'
    ...
    type: 'object',
    required: ['field', 'label', 'type', 'sensitivity'],
...
export const ListModel_AbandonedCartPublic_Schema = {
    properties: {
        results: {
            items: {
                '$ref': '#/components/schemas/AbandonedCartPublic'
            },
            type: 'array',
            title: 'Results'
        },
...
export const ListModel_TrackPublic_Schema = {
    properties: {
        results: {
            items: {
                '$ref': '#/components/schemas/TrackPublic'
            },
            type: 'array',
            title: 'Results'
        },
...
export const RecurrenceRuleSchema = {
    ...
    description: `UI-friendly representation of the subset of RFC-5545 we support.

Converted to/from a canonical RRULE string via
\`\`app.api.event.recurrence.format_rrule\`\`/\`\`parse_rrule\`\`.`
} as const;

export const RecurrenceUpdateSchema = {
    properties: {
        recurrence: {
            anyOf: [
                {
...
export const TrackCreateSchema = {
    properties: {
        popup_id: {
            type: 'string',
            format: 'uuid',
...
export const TranslationCreateSchema = {
    ...
    type: 'object',
    required: ['entity_type', 'entity_id', 'language', 'data'],
...
export const VenueAvailabilitySchema = {
    properties: {
        venue_id: {
            type: 'string',
            format: 'uuid',
        ...
        busy: {
            items: {
                '$ref': '#/components/schemas/VenueBusySlot'
            },
            type: 'array',
            title: 'Busy'
        }
...
export const VenueBookingModeSchema = {
    type: 'string',
    enum: ['free', 'approval_required', 'unbookable'],
    title: 'VenueBookingMode'
} as const;

export const VenueBusySlotSchema = {
    properties: {
        start: {
            type: 'string',
            format: 'date-time',
...
export const VenueExceptionCreateSchema = {
    ...
    title: 'VenueExceptionCreate'
} as const;

export const VenueExceptionPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'venue_id', 'tenant_id', 'start_datetime', 'end_datetime', 'is_closed', 'created_at'],
    title: 'VenueExceptionPublic'
} as const;

export const VenueExceptionRefSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'start_datetime', 'end_datetime', 'is_closed'],
    title: 'VenueExceptionRef'
} as const;

export const VenueExceptionUpdateSchema = {
    properties: {
        start_datetime: {
            anyOf: [
                {
...
export const VenuePhotoCreateSchema = {
    ...
    type: 'object',
    required: ['image_url'],
    title: 'VenuePhotoCreate'
} as const;

export const VenuePhotoPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'venue_id', 'image_url', 'position', 'created_at'],
    title: 'VenuePhotoPublic'
} as const;

export const VenuePhotoRefSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'image_url', 'position'],
    title: 'VenuePhotoRef'
} as const;

export const VenuePhotoUpdateSchema = {
    properties: {
        image_url: {
            anyOf: [
                {
    ...
    type: 'object',
    title: 'VenuePhotoUpdate'
} as const;

export const VenuePropertyRefSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
...
export const VenuePropertyTypeCreateSchema = {
    ...
    type: 'object',
    required: ['name'],
    title: 'VenuePropertyTypeCreate'
} as const;

export const VenuePropertyTypePublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'VenuePropertyTypePublic'
} as const;

export const VenuePropertyTypeUpdateSchema = {
    properties: {
        name: {
            anyOf: [
                {
...
export const VenueWeeklyHourInputSchema = {
    properties: {
        day_of_week: {
            type: 'integer',
            maximum: 6,
    ...
    title: 'VenueWeeklyHourInput'
} as const;

export const VenueWeeklyHourRefSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'day_of_week', 'open_time', 'close_time', 'is_closed'],
    title: 'VenueWeeklyHourRef'
} as const;

export const VenueWeeklyHoursUpdateSchema = {
    properties: {
        hours: {
            items: {
                '$ref': '#/components/schemas/VenueWeeklyHourInput'
            },
            type: 'array',
            title: 'Hours'
        }
