...
export class ReferralsService {
     ...
     * @param data.skip Number of items to skip
     * @param data.limit Maximum number of items to return
     * @returns ListModel_ReferralPublic_ Successful Response
     * @throws ApiError
     */
    public static listMyReferrals(data: ReferralsListMyReferralsData = {}): CancelablePromise<ReferralsListMyReferralsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/portal/referrals',
            query: {
                popup_id: data.popupId,
                skip: data.skip,
                limit: data.limit
     ...
     * @throws ApiError
     */
    public static createReferral(data: ReferralsCreateReferralData): CancelablePromise<ReferralsCreateReferralResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/portal/referrals',
            body: data.requestBody,
     ...
     * @param data The data for the request.
     * @param data.referralId
     * @param data.requestBody
     * @returns ReferralPublic Successful Response
     * @throws ApiError
     */
    public static updateMyReferral(data: ReferralsUpdateMyReferralData): CancelablePromise<ReferralsUpdateMyReferralResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/portal/referrals/{referral_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteMyReferral(data: ReferralsDeleteMyReferralData): CancelablePromise<ReferralsDeleteMyReferralResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/portal/referrals/{referral_id}',
            path: {
    ...
    /**
     * Public referral lookup (no auth)
     ...
     * @param data The data for the request.
     * @param data.code
     * @returns ReferralPublicPreview Successful Response
     * @throws ApiError
     */
    public static getReferralPreview(data: ReferralsGetReferralPreviewData): CancelablePromise<ReferralsGetReferralPreviewResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/referrals/r/{code}',
            path: {
                code: data.code
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static listReferralsAdmin(data: ReferralsListReferralsAdminData = {}): CancelablePromise<ReferralsListReferralsAdminResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getReferralAdmin(data: ReferralsGetReferralAdminData): CancelablePromise<ReferralsGetReferralAdminResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/referrals/{referral_id}',
            path: {
                referral_id: data.referralId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static updateReferralAdmin(data: ReferralsUpdateReferralAdminData): CancelablePromise<ReferralsUpdateReferralAdminResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/admin/referrals/{referral_id}',
            path: {
