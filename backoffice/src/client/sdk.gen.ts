...
export class ApplicationReviewsService {
     ...
     * @throws ApiError
     */
    public static changeMyReview(data: ApplicationReviewsChangeMyReviewData): CancelablePromise<ApplicationReviewsChangeMyReviewResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/applications/{application_id}/reviews/me',
            path: {
                application_id: data.applicationId
            },
            headers: {
...
export class ApplicationsService {
    ...
    /**
     * Override an application's final status
     ...
     * @throws ApiError
     */
    public static overrideApplicationStatus(data: ApplicationsOverrideApplicationStatusData): CancelablePromise<ApplicationsOverrideApplicationStatusResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/applications/{application_id}/status-override',
            path: {
                application_id: data.applicationId
            },
            headers: {
