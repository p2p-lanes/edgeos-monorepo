...
export class TicketEventsService {
     ...
     * @throws ApiError
     */
    public static listTicketEvents(data: TicketEventsListTicketEventsData = {}): CancelablePromise<TicketEventsListTicketEventsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
