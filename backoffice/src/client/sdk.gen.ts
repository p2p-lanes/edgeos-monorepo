...
export class PopupsService {
    ...
    /**
     * Get Popup Recap Stats
     * Aggregate recap numbers for a popup — participants only.
     * @param data The data for the request.
     * @param data.popupId
     * @returns PopupRecapStats Successful Response
     * @throws ApiError
     */
    public static getPopupRecapStats(data: PopupsGetPopupRecapStatsData): CancelablePromise<PopupsGetPopupRecapStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/popups/{popup_id}/recap-stats',
            path: {
                popup_id: data.popupId
            },
            errors: {
