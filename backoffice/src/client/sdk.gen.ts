...
export class AuthService {
     ...
     * @param data The data for the request.
     * @param data.xTenantId
     * @returns HumanSession Successful Response
     * @throws ApiError
     */
    public static humanSession(data: AuthHumanSessionData): CancelablePromise<AuthHumanSessionResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/auth/human/session',
            headers: {
                'X-Tenant-Id': data.xTenantId
            },
            errors: {
