    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          Paste HTML markup or markdown-style text. Script tags and inline event
          handlers are stripped on render — safe for marketing copy, banners,
          payment-method badges, and decorative blocks.
        </p>
        <Textarea
          id="rich-text-html"
          value={html}
            ...
            {ALIGNMENTS.map((a) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "relative rounded-lg border-2 px-3 py-2 text-center text-xs font-medium transition-all hover:bg-accent/50",
            ...
            {WIDTHS.map((w) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "relative rounded-lg border-2 px-3 py-2 text-center transition-all hover:bg-accent/50",
                    isActive ? "border-primary bg-primary/5" : "border-border",
                  )}
                  title={w.description}
                >
