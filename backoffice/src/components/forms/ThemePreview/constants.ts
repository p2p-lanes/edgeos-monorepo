...
export const PORTAL_DEFAULT_VARS: Record<string, string> = {
  ...
  "--checkout-navbar-image": "none",
  "--checkout-navbar-border": "rgba(255, 255, 255, 0.1)",
  "--checkout-badge-border": "transparent",
  "--checkout-bottom-bar-border": "rgba(255, 255, 255, 0.1)",
  "--checkout-bottom-bar-accent":
    "color-mix(in srgb, var(--checkout-bottom-bar-text) 60%, transparent)",
  "--checkout-button-border": "transparent",
  "--card": "oklch(1 0 0)",
...
export const TAB_OF_KEY: Record<string, PreviewTab> = {
  ...
  checkout_navbar_bg_to: "checkout",
  checkout_navbar_border: "checkout",
  checkout_badge_border: "checkout",
  checkout_bottom_bar_border: "checkout",
  checkout_bottom_bar_accent_color: "checkout",
  checkout_button_border: "checkout",
  // ─ legacy
  background: "home",
  foreground: "home",
  heading: "home",
