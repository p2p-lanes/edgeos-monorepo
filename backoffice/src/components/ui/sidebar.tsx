...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 lets the inset shrink below the intrinsic width of its
        // content (wide tables). Without it, a wide child pushes the inset
        // past the viewport, scrolling the page horizontally and revealing
        // the sticky topbar overlapping the sidebar on ~1366px screens.
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-3 p-2 group-data-[collapsible=icon]:items-center", className)}
      {...props}
    />
  )
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col px-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:px-0", className)}
      {...props}
    />
  )
}
