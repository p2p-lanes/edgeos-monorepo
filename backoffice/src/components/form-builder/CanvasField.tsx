        ...
        {options.length > 0 ? (
          ...
          <>
            <p className="text-xs text-muted-foreground">
              Add options in panel
            </p>
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              <div className="flex items-center gap-3 rounded-lg border border-primary/50 bg-muted p-3">
              ...
              <div className="flex items-center gap-3 rounded-lg border border-input bg-background p-3">
                <div className="h-4 w-4 shrink-0 rounded-full border-2 border-input bg-background" />
                <span className="text-sm font-medium text-muted-foreground">
                  Option 2
                </span>
              </div>
